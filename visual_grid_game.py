...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            # -----------------------------------------
            # Practical 04 Knowledge Base percepts
            # -----------------------------------------

            # TargetVisible:
            # True when an opponent is visible in the
            # current environment.
            'target_visible': (
                len(self.opponents) > 0
            ),

            # HasDust:
            # True when food/dust exists on the
            # current agent tile.
            'has_dust': (
                current_position
                in self.food_positions
            ...
            # BloodseekerMissing:
            # True when there are no opponents.
            'bloodseeker_missing': (
                len(self.opponents) == 0
            )
        }
